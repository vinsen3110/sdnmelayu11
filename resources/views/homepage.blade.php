        ...
        <div class="owl-carousel-item position-relative">
            ...
            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(53, 113, 148, 0.438)">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-sm-10 col-lg-8">
                            <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Dedicated Teachers</h5>
                            <h1 class="display-3 text-white animated slideInDown">Meet Our Excellent Educators</h1>
                            <p class="fs-5 text-white mb-4 pb-2">Passionate and experienced teachers, committed to nurturing students' learning journey every day.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-3">
                        <div class="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                <img class="img-fluid" src="{{asset('ta/img/cat-1.jpg')}}" alt="">
